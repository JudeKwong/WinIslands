; WinIslands - Universal Inno Setup installer for the 1.3.9 stable release (x64 + ARM64)
...
[Files]
Source: "..\..\releases\1.3.9\win-x64\WinIslands-1.3.9-win-x64.exe"; DestDir: "{app}"; DestName: "WinIslands.exe"; Flags: ignoreversion; Check: IsX64OS
Source: "..\..\releases\1.3.9\win-arm64\WinIslands-1.3.9-win-arm64.exe"; DestDir: "{app}"; DestName: "WinIslands.exe"; Flags: ignoreversion; Check: IsARM64
